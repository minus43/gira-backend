pipeline {
    ...
    environment {
        ...
        DEPLOY_HOSTS = "172.31.24.122,172.31.26.199,172.31.19.98,172.31.32.118" // 배포할 EC2 인스턴스의 프라이빗 IP 주소
        SERVICES = "gira-eureka,gira-gateway,gira-user,gira-board" // 현재 빌드 및 배포할 서비스
        PORTS = "8761,8181,8182,8183" // 현재 서비스의 포트
    }
